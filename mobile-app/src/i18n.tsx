...
const en: Dict = {
  ...
  'banner.revoked': 'Device access ended. Reopen the desktop QR link to pair again.',
  ...
  'detail.inputLabel': 'Mobile terminal input',
  'detail.historyTrimmed': 'Older output was trimmed to keep mobile stable.',
  ...
  'workspaces.subtitle': 'Worktrees with shared tabs',
...
const zh: Dict = {
  ...
  'banner.revoked': '设备权限已失效，请重新打开桌面端二维码完成配对。',
  'instances.title': '实例',
  ...
  'detail.inputLabel': '移动终端输入',
  'detail.historyTrimmed': '为保持手机端稳定，较早的终端内容已收起。',
  'scanner.cancel': '取消',
  'scanner.title': '扫描二维码',
  'tab.workbench': '工作台',
  'tab.terminal': '终端',
  ...
  'workspaces.subtitle': '按工作树分组的共享标签',
