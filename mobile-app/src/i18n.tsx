...
const en: Dict = {
  ...
  'instances.noActive': 'No active instances.',
  'instances.noOffline': 'No offline instances from the bridge.',
...
const zh: Dict = {
  ...
  'instances.title': '实例',
  'instances.active': '活动中',
  'instances.offline': '离线',
  'instances.noActive': '没有活动实例。',
  'instances.noOffline': '桥接没有离线实例。',
  'settings.title': '设置',
