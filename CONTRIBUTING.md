...
Thanks for your interest in contributing to OpenWork! Before you start, please take a moment to read through this guide.

## Before You Start

- **Search first.** Check [existing issues](https://source.example.com/openwork/openwork/issues) and [pull requests](https://source.example.com/openwork/openwork/pulls) to avoid duplicating work.
- **Discuss first** for new features. Open an [issue](https://source.example.com/openwork/openwork/issues/new) to discuss your idea before investing time in implementation. We may already have plans or opinions on how it should work.
...
2. Clone your fork:
   ```bash
   git clone https://source.example.com/<your-username>/openwork.git
   cd openwork
   ```
...
Releases are managed by maintainers using [release-it](https://source.example.com/release-it/release-it) with the [conventional changelog plugin](https://source.example.com/release-it/conventional-changelog).
...
- Creates a git tag and source hosting Release
- Publishes to npm

## License

By contributing, you agree that your contributions will be licensed under the [UNLICENSED License](LICENSE).