  ...
  return (
    <>
      <button
        ...
        onMouseDown={stop}
        className={[
          'inline-flex shrink-0 appearance-none items-center justify-between rounded-md border border-border bg-background text-muted-foreground outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:ring-2 focus:ring-ring/40',
          compact
            ? 'h-7 w-[104px] gap-1.5 px-2 text-[11px]'
      ...
      {open && menuRect && createPortal(
        <div
          ...
          onClick={stop}
          onMouseDown={stop}
          className="fixed z-popover rounded-md border border-border bg-popover p-1 text-xs text-popover-foreground shadow-xl"
          style={{
            left: menuRect.left,
            top: menuRect.top,
