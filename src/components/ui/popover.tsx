  ...
  ({ align = 'center', side = 'bottom', className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'absolute z-50 rounded-[var(--radius-md)] border border-white/10 bg-background/80 backdrop-blur-xl p-1.5 text-popover-foreground shadow-[0_10px_40px_rgba(0,0,0,0.3)] outline-none',
          sideClass,
          alignClass,
          className,
        )}
