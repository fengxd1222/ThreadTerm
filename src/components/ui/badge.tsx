...
const badgeVariants = cva(
  'inline-flex items-center rounded-[var(--radius-md)] border px-2.5 py-0.5 text-[10px] font-semibold tracking-wider uppercase transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        outline: 'text-foreground border-white/10/50 backdrop-blur-sm',
      },
    },
    defaultVariants: {
      variant: 'default',
