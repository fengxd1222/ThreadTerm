...
function ApiKeysSettings() {
  ...
  const createGithubToken = async () => {
    ...
    try {
      ...
      console.error('Error creating source hosting token:', error);
    }
  };
  ...
  const deleteGithubToken = async (tokenId) => {
    ...
    try {
      ...
      console.error('Error deleting source hosting token:', error);
    }
  };
  ...
  const toggleGithubToken = async (tokenId, isActive) => {
    try {
      ...
      console.error('Error toggling source hosting token:', error);
    }
  };
